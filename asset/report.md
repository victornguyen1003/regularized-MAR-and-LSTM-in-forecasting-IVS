...
<!-- _class: lead -->
# Regularized MAR and Residual LSTM
# in forecasting IV Surface
...
<div style="display: flex; align-items: center; justify-content: space-between; gap: 40px; width: 100%;">
  ...
  <div style="flex: 1.2; min-width: 0;">
    <strong>Source:</strong> Bloomberg<br>
    <strong>Time period:</strong> 4/1/2016 - 5/25/2026<br>
    <strong>Moneyness (S/K):</strong> 80%, 90%, 95%, 97.5%, 100%, 102.5%, 105%, 110%, 120%<br>
    <strong>Time to maturity:</strong> 1M, 2M, 3M, 6M, 12M, 18M, 24M<br>
    <i>Each IV surface is a 7x9 matrix</i>
  </div>

  <div style="flex: 1; display: flex; justify-content: center; align-items: center;">
    <img src="figure/ivs_20260525.png" width="500" height="500" alt="IVS Chart" style="max-width: 100%; height: auto;" />
  </div>
